...
export default {
  ...
  computed: {
    ...
    name() {
      return `Автопокупатель ${AntimatterDimension(this.tier).shortDisplayName}-го Измерения`;
    },
    modeDisplay() {
      switch (this.mode) {
        case AUTOBUYER_MODE.BUY_SINGLE: return "Покупает один";
        case AUTOBUYER_MODE.BUY_10: return "Покупает всё";
      }
