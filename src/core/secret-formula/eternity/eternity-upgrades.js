...
export const eternityUpgrades = {
  idMultEP: {
    id: 1,
    cost: 5,
    description: () => `Множитель Измерениям Бесконечности в зависимости от непотраченных Очков Вечности (x+${formatInt(1)})`,
  ...
  idMultEternities: {
    id: 2,
    cost: 10,
    description: () => `Множитель Измерениям Бесконечности в зависимости от Вечностей
      ((x/${formatInt(200)})^log4(${formatInt(2)}x), частичное ограничение при ${format(1e5)} Вечностях)`,
    effect() {
  ...
  idMultICRecords: {
    id: 3,
    cost: 5e4,
    description: "Множитель Измерениям Бесконечности в зависимости от суммы времени прохождений Испытаний Бесконечности",
  ...
  tdMultAchs: {
    id: 4,
    cost: 1e16,
    description: "Бонус от достижений также влияет на Измерения Времени",
  ...
  tdMultTheorems: {
    id: 5,
    cost: 1e40,
    description: "Измерения Времени умножены на кол-во непотраченных Теорем Времени",
  ...
  tdMultRealTime: {
    ...
    description: () => (Pelle.isDoomed
      ...
      : "Измерения времени умножены на сыгранные дни"
    ),
